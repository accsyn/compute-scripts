'''
	...
	Houdini 19.0 accsyn compute app script.
    ...
    def get_executable(self):
        ...
        if not Common._dev:
            if Common.is_lin():
                ...
                return "/library/software/networkinstall/linux/houdini/hfs19.0.383/bin/mantra"
            elif Common.is_mac():
                return "/Applications/Houdini/Houdini19.0.383//Frameworks/Houdini.framework/Versions/18.5/Resources/bin/mantra"
            elif Common.is_win():
